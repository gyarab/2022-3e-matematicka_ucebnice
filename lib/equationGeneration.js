    ...
    for (let i = 0; i < size; i++){
        switch(getRandomInt(1,4)) {
            ...
            case 4:
                ...
                if (list.length !== 0){
                    let numbersOfMultiplying = getRandomInt(1,3);
                    let a = 1;
                    for(let i = 0; i < numbersOfMultiplying; i++){
                        let listNum = list[getRandomInt(0,list.length)];
 ...
 * 
 * This method returns list of numbers that are in this number ///(jakube help s AJ)
 * 
 * @param {int} n 
 * @returns {list}
 */
